...
namespace Models
{
    ...
    public partial class Rung
    {
        ...
        public int? nguon_goc_id { get; set; }
        public int? dieu_kien_id { get; set; }
        public int? loai_cay_id { get; set; }
        public int? muc_dich_id { get; set; }
        public int? chu_id { get; set; }
        public int? tru_luong_id { get; set; }
}
